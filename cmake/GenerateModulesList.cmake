...
foreach (SS4S_MODULE_TARGET ${SS4S_MODULE_TARGETS})
    ...
    get_target_property(SS4S_MODULE_${_GROUP}_CONFLICTS ${SS4S_MODULE_TARGET} SS4S_MODULE_CONFLICTS)
    get_target_property(SS4S_MODULE_${_GROUP}_OS_VERSION ${SS4S_MODULE_TARGET} SS4S_MODULE_OS_VERSION)
...
foreach (_GROUP ${SS4S_MODULE_GROUPS})
    ...
    string(REPLACE ";" "," _MODULES "${SS4S_MODULE_${_GROUP}_MODULES}")
    file(APPEND "${SS4S_MODULES_INI_OUTPUT_FILE}" "modules = ${_MODULES}\n")
    ...
    if (SS4S_MODULE_${_GROUP}_CONFLICTS)
        string(REPLACE ";" "," _CONFLICTS "${SS4S_MODULE_${_GROUP}_CONFLICTS}")
        file(APPEND "${SS4S_MODULES_INI_OUTPUT_FILE}" "conflicts = ${_CONFLICTS}\n")
    endif ()
    if (SS4S_MODULE_${_GROUP}_OS_VERSION)
        file(APPEND "${SS4S_MODULES_INI_OUTPUT_FILE}" "os_version = ${SS4S_MODULE_${_GROUP}_OS_VERSION}\n")
    endif ()
